...
class ApacheSolrSink(override val input: Source<SolrInputDocument>, private val config: SolrConfig): Sink<SolrInputDocument>, Closeable {
    ...
    companion object {
        ...
        /** Required fields that are generated by the system. */
        private val REQUIRED_SYSTEM_FIELDS = setOf("_version_", "_fulltext_", "institution_s", "objekttyp_s")
    }
    ...
    private fun initializeValidators() {
        for (c in this.config.collections) {
            ...
            val validators = fields.mapNotNull { schemaField ->
                if (schemaField["name"] !in REQUIRED_SYSTEM_FIELDS) {
