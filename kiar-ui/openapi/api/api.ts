...
export * from './sRU.service';
export * from './session.service';
export * from './user.service';
export const APIS = [ApacheSolrService, CollectionService, ConfigService, EntityMappingService, InstitutionService, JobService, JobTemplateService, MasterdataService, OAIService, ParticipantService, PublicationService, SRUService, SessionService, UserService];
