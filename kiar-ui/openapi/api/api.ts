...
export const APIS = [ApacheSolrService, ConfigService, EntityMappingService, InstitutionService, JobService, JobTemplateService, ParticipantService, SessionService, TransformerService];
